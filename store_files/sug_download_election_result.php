		...
		while($row = $stmt->fetch(PDO::FETCH_ASSOC)) 
		{
			...
			$total_vote =number_format($total_vote,2);
				$html1 .='<tr style="font-weight:bold;">
					<td style="text-align:right;color:white" colspan="2">Total N<u>o</u> Contesting for - '.$row['sug_post'].' :</td>
					<td style="text-align:left;" >'.$Amount_total_display.'</td>
					<td style="text-align:right;color:white" colspan="2">Total N<u>o</u> Of Votes Casted for - '.$row['sug_post'].' :</td>
					<td style="text-align:left;" >'.$total_vote.' Votes !</td>
				</tr>';
		}

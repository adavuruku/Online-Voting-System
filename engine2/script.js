...
// http://javascript-source.com
//***********************************************
jQuery("#wowslider-container2").wowSlider({effect:"blinds",prev:"",next:"",duration:12*100,delay:20*100,width:900,height:500,autoPlay:true,playPause:true,stopOnHover:false,loop:false,bullets:1,caption:true,captionEffect:"slide",controls:true,onBeforeStep:0,images:0});